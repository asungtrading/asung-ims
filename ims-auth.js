...
(function(){
  ...
  function setupNavMenu(meData){
    ...
    //    ⭐ [2026-09-25 Caleb] 이름은 보이는 글자만 바꿨다(파일 이름 그대로) — Purchase Invoices(invoices.html) · Supplier Payments(payments.html). 판매 묶음의 나머지(Backorders)는 화면이 설 때 더한다 · ✅ [2026-09-25] Sales Invoices(so-invoices.html) · Customer Payments(so-payments.html) · Credit Notes(so-credits.html) 섰다.
